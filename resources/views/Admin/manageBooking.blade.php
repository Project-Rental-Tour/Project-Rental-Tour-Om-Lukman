...
@section('pageTitle', 'Manage Booking')
        ...
        <div class="px-4 md:px-6 py-4 md:py-6 bg-white shadow-sm">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Manage data Booking dan Informasi Booking</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="flex gap-2">
                    <button type="button"
                        ...
                        data-route="{{ route('manage-booking.bulk-destroy') }}" data-item-type="booking">
                ...
                <div class="relative">
                    <select onchange="window.location.href = '{{ route('manage-booking.index') }}' + this.value"
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-500">
                                        ...
                                        @if(request()->filled('search'))
                                            <button type="button"
                                                onclick="window.location.href='{{ route('manage-booking.index') }}'"
                            ...
                            @foreach ($bookings as $booking)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <input type="checkbox" name="ids[]" value="{{ $booking->booking_id }}"
                                            class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 bulk-checkbox"
                                            aria-label="Select booking from {{ $booking->first_name }}">
                                    </td>
