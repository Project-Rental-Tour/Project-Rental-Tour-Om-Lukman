    ...
    <div class="relative bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <p class="mb-4 text-gray-600">Are you sure you want to delete "<span
                    class="font-semibold">{{ $destination->name_package }}</span>"? This action cannot be undone.</p>
            <div class="flex justify-end space-x-3">
                ...
                <form action="{{ route('manage-destination.destroy', $destination->destination_id) }}" method="POST"
                    class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
