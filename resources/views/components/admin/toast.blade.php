...
<template id="toast-template">
    <div id="toast-{id}" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-sm shadow-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:shadow-gray-900" role="alert">
...
// Display toasts from session if available
