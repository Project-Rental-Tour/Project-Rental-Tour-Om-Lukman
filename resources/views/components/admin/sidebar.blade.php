...
<div id="sidebar-overlay" class="hidden fixed inset-0 z-40 bg-gray-600 bg-opacity-75 md:hidden"></div>

<!-- Sidebar -->
<div id="sidebar"
    class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 -translate-x-full transform border-r border-gray-200 bg-white md:relative md:translate-x-0 md:flex md:flex-shrink-0 transition-transform duration-300 ease-in-out">
    <!-- Header Sidebar -->
    ...
    <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-4">
            @csrf
            <button type="submit"
                class="flex items-center w-full px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 text-gray-600 hover:bg-red-100 hover:text-red-600">
