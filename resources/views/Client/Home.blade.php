...
@section('content')
    ...
    : asset('assets/images/jumbotron/background-jumbo.png') }}" 
        ...
        <!-- Header -->
        <div class="text-center mb-12 animate-fade-up">
            <span class="inline-block text-primary text-sm font-semibold tracking-wider uppercase bg-blue-100 px-4 py-1.5 rounded-full">
                Testimonials
            </span>
            <h3 class="text-4xl font-bold text-gray-900 mt-4 mb-4">
            ...
            <div class="swiper-wrapper">
                @foreach($testimonials as $testimoni)
                    <div class="swiper-slide px-4 py-6">
                        <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex flex-col h-[260px]">
                            ...
                            <!-- Testimonial Content -->
                            <p class="text-gray-600 italic flex-grow leading-relaxed text-sm mb-6 line-clamp-4">
                                {{ $testimoni->content }}
                            </p>
                            ...
                            <div class="flex items-center gap-3 mt-auto">
                                <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                                    <i class="fa-regular fa-circle-user text-gray-500 text-xl"></i>
                                </div>
                                <div>
                                    ...
                                    <p class="text-gray-500 text-xs">
                                        {{ $testimoni->role }}, {{ $testimoni->location }}
                                    </p>
                                </div>
                            </div>
                        </div>
