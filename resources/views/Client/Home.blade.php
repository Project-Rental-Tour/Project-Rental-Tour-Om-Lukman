...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-6 py-24" id="booking-process">
        <div class="text-center mb-20 animate-fade-up">
            ...
            <h3 class="text-4xl font-bold text-gray-900 mb-6">Easy Booking Process</h3>
            <p class="text-gray-600 max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <!-- Regular Booking -->
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 animate-fade-up" style="transition-delay: 0.2s">
                <div class="flex items-center mb-6">
                    <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                        <i class="fas fa-box text-blue-600"></i>
                    </div>
                    <h4 class="text-2xl font-bold text-gray-900">Regular Package</h4>
                </div>
                <p class="text-gray-600 mb-6">Choose from our curated destinations and book in just a few steps.</p>

                <ol class="space-y-5">
                    <li class="flex items-start">
                        <div class="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">1</div>
                        <div>
                            <strong>Pilih Destinasi</strong>
                            <p class="text-gray-600 text-sm">Browse our top destinations and select the one you love.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">2</div>
                        <div>
                            <strong>Lihat Detail</strong>
                            <p class="text-gray-600 text-sm">Review itinerary, inclusions, and pricing.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">3</div>
                        <div>
                            <strong>Isi Form Booking</strong>
                            <p class="text-gray-600 text-sm">Fill in your details and preferences.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">4</div>
                        <div>
                            <strong>Kirim & Tunggu Konfirmasi</strong>
                            <p class="text-gray-600 text-sm">Submit and our admin will follow up shortly.</p>
                        </div>
                    </li>
                </ol>

                <a href="#destination"
                   class="mt-6 inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition w-full justify-center shadow-md hover:shadow-lg animate-pulse">
                    Explore Destinations <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>

            <!-- Custom Booking -->
            <div class="bg-gradient-to-br from-purple-600 to-indigo-800 text-white p-8 rounded-2xl shadow-lg animate-fade-up" style="transition-delay: 0.4s">
                <div class="flex items-center mb-6">
                ...
                <p class="mb-6 text-purple-100">Want something unique? Tell us your dream trip and we’ll make it happen.</p>

                <ol class="space-y-5">
                    <li class="flex items-start">
                        <div class="bg-white text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">1</div>
                        <div>
                            <strong>Pilih Opsi Custom</strong>
                            <p class="text-purple-100 text-sm">Click on “Create Your Own Adventure”.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-white text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">2</div>
                        <div>
                            <strong>Isi Form Custom</strong>
                            <p class="text-purple-100 text-sm">Tell us your destination, date, group size, and preferences.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-white text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">3</div>
                        <div>
                            <strong>Kirim Permintaan</strong>
                            <p class="text-purple-100 text-sm">Submit your idea and let us craft your perfect itinerary.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="bg-white text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-4 mt-1">4</div>
                        <div>
                            <strong>Tunggu Follow-Up</strong>
                            <p class="text-purple-100 text-sm">Our team will contact you with a personalized proposal.</p>
                        </div>
                    </li>
                </ol>

                <a href="{{ route('booking.custom') }}"
                   class="mt-6 inline-flex items-center px-6 py-3 bg-white text-purple-700 font-semibold rounded-lg hover:bg-gray-100 transition w-full justify-center shadow-md hover:shadow-lg">
        ...
        <!-- Decorative Elements -->
        <div class="flex justify-center mt-12 animate-fade-up" style="transition-delay: 0.6s">
