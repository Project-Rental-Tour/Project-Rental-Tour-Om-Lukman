...
@section('content')
                ...
                <section class="max-w-7xl mx-auto px-6 py-24" id="about">
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2 space-y-6 animate-fade-up">
                            ...
                            <button class="bg-blue-700 text-white px-8 py-4 rounded-xl hover:bg-blue-700 transition flex items-center shadow-md hover:shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        @foreach ($destinations as $destination)
                                ...
                                <div class="p-6 flex flex-col flex-grow">
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ $destination->name_package }}</h3>
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        class="inline-flex items-center justify-between px-8 py-3 text-lg font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-700 transition w-full">
                                            <span class="text-left">Book Now</span>
                            ...
                            <div class="relative h-48 overflow-hidden">
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <div class="text-center text-white">
                                        <i class="fas fa-magic text-4xl mb-4 opacity-90 group-hover:scale-110 transition-transform"></i>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24" id="booking-process">
        <div class="text-center mb-20 animate-fade-up">
            ...
            <h3 class="text-4xl font-bold text-gray-900 mb-6">Simple & Stress-Free Booking</h3>
            <p class="text-gray-600 max-w-2xl mx-auto text-lg">
                Whether you're choosing a ready-made package or designing your dream trip, booking with us is fast, easy, and fully supported by our team.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <!-- Regular Booking -->
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300 animate-fade-up" style="transition-delay: 0.2s">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mr-4">
                        <i class="fas fa-suitcase-rolling text-blue-600 text-xl"></i>
                    </div>
                    <h4 class="text-2xl font-bold text-gray-900">Book a Package</h4>
                </div>
                <p class="text-gray-600 mb-8 leading-relaxed">
                    Explore our top-rated travel packages and book your next adventure in just a few clicks.
                </p>

                <ol class="space-y-6">
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">1</div>
                        <div>
                            <strong class="font-semibold">Choose a Destination</strong>
                            <p class="text-gray-600 text-sm mt-1">Browse our curated list of top destinations and select your favorite.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">2</div>
                        <div>
                            <strong class="font-semibold">View Details</strong>
                            <p class="text-gray-600 text-sm mt-1">Check the itinerary, inclusions, pricing, and traveler reviews.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">3</div>
                        <div>
                            <strong class="font-semibold">Fill Booking Form</strong>
                            <p class="text-gray-600 text-sm mt-1">Provide your details, travel dates, and any special requests.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">4</div>
                        <div>
                            <strong class="font-semibold">Submit & Wait for Confirmation</strong>
                            <p class="text-gray-600 text-sm mt-1">Our team will contact you shortly to confirm your booking and next steps.</p>
                        </div>
                    </li>
                </ol>

                <a href="#destination"
                   class="mt-8 inline-flex items-center justify-center px-7 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all duration-300 w-full shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    Explore Packages <i class="fas fa-external-link-alt ml-2 text-sm"></i>
                </a>
            </div>

            <!-- Custom Booking -->
            <div class="bg-gradient-to-br from-purple-600 to-indigo-800 text-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 animate-fade-up" style="transition-delay: 0.4s">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mr-4">
                        <i class="fas fa-magic text-xl"></i>
                    </div>
                    <h4 class="text-2xl font-bold">Design Your Trip</h4>
                </div>
                <p class="mb-8 text-purple-100 leading-relaxed">
                    Want something unique? Tell us your vision, and we’ll craft a personalized travel experience just for you.
                </p>

                <ol class="space-y-6">
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-white text-purple-700 rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">1</div>
                        <div>
                            <strong class="font-semibold">Select "Custom Trip"</strong>
                            <p class="text-purple-100 text-sm mt-1">Click on “Create Your Own Adventure” to get started.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-white text-purple-700 rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">2</div>
                        <div>
                            <strong class="font-semibold">Complete the Request Form</strong>
                            <p class="text-purple-100 text-sm mt-1">Tell us your destination, travel dates, group size, interests, and preferences.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-white text-purple-700 rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">3</div>
                        <div>
                            <strong class="font-semibold">Submit Your Idea</strong>
                            <p class="text-purple-100 text-sm mt-1">Send your request and let our experts design your perfect itinerary.</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex-shrink-0 w-8 h-8 bg-white text-purple-700 rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-0.5">4</div>
                        <div>
                            <strong class="font-semibold">Wait for Our Proposal</strong>
                            <p class="text-purple-100 text-sm mt-1">We’ll get back to you with a tailored plan and pricing within 24 hours.</p>
                        </div>
                    </li>
                </ol>

                <a href="{{ route('booking.custom') }}"
                   class="mt-8 inline-flex items-center justify-center px-7 py-4 bg-white text-purple-700 font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 w-full shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    Start p balap asek bismillah <i class="fas fa-arrow-right ml-2 text-sm"></i>
                </a>
            </div>
        </div>

        <!-- Decorative Divider -->
        <div class="flex justify-center mt-16 animate-fade-up" style="transition-delay: 0.6s">
            <div class="w-20 h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 rounded-full"></div>
        </div>
    </section>
