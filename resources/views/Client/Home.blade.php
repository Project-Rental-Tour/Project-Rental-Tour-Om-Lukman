    ...
    : asset('assets/images/jumbotron/background-jumbo.png') }}" 
                            ...
                            class="absolute inset-0 w-full h-full object-cover object-center opacity-70 transition-opacity duration-500">
                                    ...
                                    <div class="container mx-auto px-6 relative z-20 text-center">
                                        ...
                                        <a href="#destination"
                                        class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white rounded-full transition transform hover:scale-105 shadow-lg animate-fade-up" style="background-color: #799eff"
