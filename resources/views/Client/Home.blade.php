                ...
                @foreach ($destinations as $destination)
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 flex flex-col h-[350px] animate-fade-up" style="transition-delay: 0.1s">
                        ...
                        <div class="relative h-48 overflow-hidden">
                            <img src="{{ asset('storage/' . $destination->image ?? 'assets/images/placeholder.jpg') }}"
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('destination.show', $destination->slug) }}"
                                   class="w-full text-light py-3 rounded-xl font-semibold transition-all duration-300 hover:bg-warning group-hover:scale-105 flex items-center justify-center">
                                    <span>Book Now</span>
