    ...
    class="absolute inset-0 w-full h-full object-cover object-center opacity-70 transition-opacity duration-500">
            ...
            <div class="container mx-auto px-6 relative z-20 text-center">
                ...
                <a href="#top-destination"
                   class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-primary rounded-full hover:bg-blue-700 transition transform hover:scale-105 shadow-lg animate-fade-up"
                ...
                @foreach ($destinations as $destination)
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mt-auto">
                            ...
                            class="inline-flex items-center px-8 py-3 text-lg font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-700 transition">
                                Book Now
                ...
                <div class="swiper-wrapper">
                    @foreach($testimonials as $testimoni)
                        <div class="swiper-slide px-4 py-8">
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 flex flex-col h-[300px]">
                                ...
                                <!-- Testimonial -->
                                <p class="text-gray-600 italic flex-grow leading-relaxed text-sm">
                                    {{ $testimoni->content }}
                                </p>
                                ...
                                <div class="flex items-center mt-5">
                                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                        alt="{{ $testimoni->name }}"
                                        class="w-8 h-8 rounded-full object-cover mr-3 border-2 border-blue-500">
                                    <div>
