...
@section('head')
    ...
    <style>
        ...
        /* Changed from Gold to Blue Sapphire Gradient */
        .text-gradient-gold {
        ...
        .glass-card {
            ...
            box-shadow: 0 8px 32px 0 rgba(0, 51, 102, 0.08); /* Blue tinted shadow */
        }

        .glass-dark {
            background: rgba(0, 51, 102, 0.8); /* Dark Blue Glass */
...
@section('content')
    ...
    <section id="jumbotron" class="relative min-h-[100vh] flex items-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            {{-- Note: Ensure the image works well with blue. If possible, use an image with water or sky --}}
            <img 
    ...
    <section id="why-choose-us" class="w-full py-20 md:py-32 relative overflow-hidden bg-surface">
        {{-- Updated colors for background blobs: Secondary Blue and Primary Navy --}}
        <div class="absolute top-0 right-0 w-[400px] h-[400px] bg-[#00b4d8]/10 rounded-full mix-blend-multiply filter blur-[100px] opacity-60 animate-float-slow"></div>
        <div class="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#003366]/10 rounded-full mix-blend-multiply filter blur-[100px] opacity-60 animate-float-slow" style="animation-delay: -4s"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach([
                    ['Expert Guidance', 'Curated by insiders who know every hidden path.', 'fas fa-map-marked-alt', 'blue'],
                    ['Best Value', 'Luxury experiences at fair pricing with no hidden costs.', 'fas fa-tag', 'cyan'],
                    ['24/7 Concierge', 'Round-the-clock assistance for peace of mind.', 'fas fa-headset', 'indigo'],
                    ['Eco-Conscious', 'We prioritize responsible tourism and sustainability.', 'fas fa-leaf', 'emerald'],
                    ['Flexible Plans', 'Change of plans? We adapt instantly to your needs.', 'fas fa-calendar-check', 'sky'],
                    ['Tailored for You', 'Customizable to your personal rhythm and style.', 'fas fa-sliders-h', 'violet']
                ] as $index => $feature)
    ...
    {{-- 4. BOOKING PROCESS (Blue & White Theme) --}}
    <section id="booking-process" class="py-24 bg-surface relative overflow-hidden">
        {{-- Updated blob colors to Blue --}}
        <div class="absolute top-0 right-0 w-96 h-96 bg-[#00b4d8]/5 rounded-full blur-3xl -mr-20 -mt-20"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-[#003366]/5 rounded-full blur-3xl -ml-20 -mb-20"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group cursor-pointer animate-fade-up">
                    ...
                    <a href="{{ route('blogs.detail', $blog->slug) }}" class="inline-flex items-center text-sm font-bold text-primary group-hover:translate-x-1 transition-transform border-b-2 border-primary/20 pb-1">
