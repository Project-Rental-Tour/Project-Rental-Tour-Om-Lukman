...
@section('content')
            ...
            <div class="lg:col-span-1 hidden lg:block">
                <div class="glass-card p-8 rounded-[2.5rem] shadow-2xl sticky top-28 animate-fade-up border border-white/60" style="animation-delay: 0.4s">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', optional($profiles)->phone_number ?? '6281220005276') }}?text=Halo%20Admin%20GOING%20TO%20THE%20JAVA,%20Saya%20tertarik%20dengan%20{{ $destination->name_package }}" 
                           target="_blank"
    ...
    {{-- MOBILE STICKY BOOKING BAR (Only visible on mobile) --}}
    ...
    <a 
        ...
        id="whatsapp-float"
        class="fixed bottom-24 lg:bottom-8 right-6 bg-green-500 text-white px-4 py-3 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 transform scale-0 opacity-0 z-50 flex items-center gap-2 group animate-bounce-slow"
    >
